...
✅ *Пвысы:* Идеален для долгих боев, высочайшая выживаемость.
...
async def code_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ✅ Твой продвинутый фикс с склеиванием фраз и очисткой пробелов!
...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message.photo:
        ...
        if not user_text: user_text = "Проанализируй скриншот снаряжения/навыков."
